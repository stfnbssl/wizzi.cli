...
module.exports = {
    meta: "example-meta1-js-scripts", 
    metaCtxPath: path.join(__dirname, '_meta', 'meta.js.scripts.json.ittf'), 
    destPath: "C:/My/wizzi/stfnbssl/wizzi.cli/packages/wizzi.scripts",
    plugins: [
