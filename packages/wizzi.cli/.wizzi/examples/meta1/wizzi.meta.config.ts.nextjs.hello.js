...
module.exports = {
    meta: "example-meta1-ts-nextjs-hello", 
    metaCtxPath: path.join(__dirname, '_meta', 'meta.ts.nextjs.hello.json.ittf'), 
    destPath: "C:/My/wizzi/stfnbssl/wizzi.demo/packages/ts.nextjs.hello",
    plugins: [
