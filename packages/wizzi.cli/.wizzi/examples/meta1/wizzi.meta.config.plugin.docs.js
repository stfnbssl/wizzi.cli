...
module.exports = {
    meta: "example-meta1-plugin-docs", 
    metaCtxPath: path.join(__dirname, '_meta', 'meta.plugin.docs.json.ittf'), 
    destPath: "C:/My/wizzi/stfnbssl/wizzi.plugins/packages/wizzi.plugin.docs",
    plugins: [
