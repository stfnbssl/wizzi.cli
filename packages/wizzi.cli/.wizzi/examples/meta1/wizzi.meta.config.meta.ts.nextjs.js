...
module.exports = {
    meta: "example-meta1-meta-ts-nextjs", 
    metaCtxPath: path.join(__dirname, '_meta', 'meta.meta.ts.nextjs.json.ittf'), 
    destPath: "C:/My/wizzi/stfnbssl/wizzi.metas/packages/wizzi.meta.ts.nextjs",
    plugins: [
